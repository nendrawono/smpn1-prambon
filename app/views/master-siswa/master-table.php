              ...
              <tr>
                  ...
                  <td>
                      ...
                      <form action="<?= BASE_URL; ?>/mastersiswa/delete/<?= $o['id']; ?>" method="post" class="d-inline">
                          ...
                          <button type="submit" title="Hapus" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin?');"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
