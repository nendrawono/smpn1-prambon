...
class DashboardGuru extends Controller
{
    public function index()
    {
        ...
        // var_dump("dashboard guru");
        // die();
        $id_siswa = $_SESSION["user_login"]['siswa']['nip'];
        $tahun_ajaran_id = $_SESSION["user_login"]['tahun_ajaran']['id'];
        $data_guru = $_SESSION["user_login"]['siswa'];

        // var_dump ($_SESSION["user_login"]['siswa']);
        // die();
        ...
        $this->view('dashboard-guru/index', $data);
