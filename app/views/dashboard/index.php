                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <img src="<?= $_SESSION["user_login"]['siswa']['reff_passfoto'] ?>" id="foto_siswa_v" alt="foto-siswa" alt="foto-siswa" width="150" height="150">
                            </div>
                        </div> 
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>NIS</label>
                                <p style="margin-top:-0.75rem!important"><?= $_SESSION["user_login"]['siswa']['nis'] ?></p>
                            </div>
                            <div class="form-group">
                                <label>Kelas</label>
                                <p style="margin-top:-0.75rem!important"><?= $_SESSION["user_login"]['kelas_sekarang']['nm_kelas'] ?></p>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>Nama</label>
                                <p style="margin-top:-0.75rem!important"><?= $_SESSION["user_login"]['siswa']['nm_siswa'] ?></p>
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                <p style="margin-top:-0.75rem!important"><?= $_SESSION["user_login"]['siswa']['deleted_at'] == null ? "Aktif": "Non Aktif" ?></p>
                            </div>
                            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <input type="hidden" value="<?= $_SESSION["user_login"]['siswa']['kelas_sekarang'] ?>" id="kelas_sekarang_id"></input>
