<div class="card">
    ...
    <div class="card-body">
      <table id="tablematpel" class="table table-bordered table-striped">
        <thead>
          <tr>
            <th style="width: 5%">#</th>
          ...
          <?php $i = 1; ?>
          <?php foreach ($data['matpel'] as $o) : ?>
              <tr>
                  <th scope="row"><?= $i++; ?></th>
                  <td><?= $o['nm_matpel']; ?></td>
                  <td style="width:10%"><?= $o['kkm']; ?></td>
                  <td style="width:10%"><?= $o['kelompok']; ?></td>
                  <td style="width:42%">
                    <!-- <a href="#" class="show_hide" data-content="toggle-text">Baca selengkapnya</a>
                    <div class="content_deskripsi"><?//= $o['deskripsi']; ?></div> -->
                    <?= $o['deskripsi']; ?>
                  </td>
                  <td  style="width:10%">
                      ...
                      <form action="<?= BASE_URL; ?>/mastermatpel/delete/<?= $o['id']; ?>" method="post" class="d-inline">
