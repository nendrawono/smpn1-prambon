<div class="card">
    ...
    <div class="card-body">
      <table id="tabletahunajaran" class="table table-bordered table-striped">
        <thead>
          <tr>
            <th style="width: 5%">#</th>
            <th>Tahun Ajaran</th>
          ...
          <?php $i = 1; ?>
          <?php foreach ($data['tahun_ajaran'] as $o) : ?>
              <tr>
                  <th scope="row"><?= $i++; ?></th>
                  <td><?= $o['tahun_ajaran']; ?></td>
                  <td><?= $o['semester']; ?></td>
                  <td><?= $o['is_active'] == "1" ? "<span class='badge badge-success right'>Active</span> ": "" ?></td>
                  <td>
                      ...
                      <form action="<?= BASE_URL; ?>/pengaturantahunajaran/delete/<?= $o['id']; ?>" method="post" class="d-inline">
