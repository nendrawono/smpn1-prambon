<div class="card">
    ...
    <div class="card-body">
      <table id="tablejenisabk" class="table table-bordered table-striped">
        <thead>
          <tr>
            <th style="width: 5%">#</th>
            <th>JENIS ABK</th>
          ...
          <?php $i = 1; ?>
          <?php foreach ($data['jenis_abk'] as $o) : ?>
              <tr>
                  <th scope="row"><?= $i++; ?></th>
                  <td><?= $o['jenis_abk']; ?></td>
                  <td>
                      ...
                      <form action="<?= BASE_URL; ?>/masterjenisabk/delete/<?= $o['id']; ?>" method="post" class="d-inline">
